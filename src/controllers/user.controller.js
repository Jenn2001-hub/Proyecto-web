...
exports.getAllUsersByAdministradorId = async (req, res) => {
    try {
        ...
        const { nombre, email } = req.query; // Obtiene el email como filtro opcional
        const users = await userService.getAllUsersByAdministradorId(admin_from_token, nombre,  email); // Llama al servicio para obtener los usuarios
...
exports.updateUser = async (req, res) => {
    ...
    try {
        const user = await userService.updateUser(id, nombre, email, rol_id, administrador_id, admin_from_token); // Llama al servicio para actualizar el usuario
